...
const operationMetadata = {
	...
	method:             `DELETE`,
	description:        `Deletes a employee based on the ID supplied.`,
	parameters:         { employee_id: { description: `ID of the employee to delete`, type: `query`, optional: false  } },
	scopes:             [ `delete:employees` ],
	modelName:          `Employee`,
	...
	Object.assign(operationMetadata, {
		async action (req, resp, next) {
			...
			try {
				...
				const result = await api.employees.deleteByEntityId(employee_id);

				// DEBUG: delete-employee result
				// console.debug(`🦠  delete-employee result: ${JSON.stringify(result, null, 2)}`);
