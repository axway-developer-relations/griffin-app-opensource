...
const operationMetadata = {
	group:       `schedules`,
	name:        `get-office-schedules`,
	path:        `/api/v1/offices/:office_id/schedules`,
	method:      `GET`,
	description: `Returns schedules associated with office identified by supplied office_id.`,
	parameters:  {
		office_id: { description: `ID of the office to find associated schedules`, type: `query`, optional: false  },
	...
	scopes:             [ `read:schedules`, `read:offices`  ],
	modelName:          `Schedule`,
	...
	Object.assign(operationMetadata, {
		async action (req, resp, next) {
			...
			try {
				...
				// DEBUG: get-office-schedules result
				// console.debug(`🦠  get-office-schedules result: ${JSON.stringify(result, null, 2)}`);
