...
const operationMetadata = {
	...
	method:             `DELETE`,
	description:        `Deletes a schedule based on the ID supplied.`,
	parameters:         { schedule_id: { description: `ID of the schedule to delete`, type: `query`, optional: false  } },
	scopes:             [ `delete:schedules` ],
	modelName:          `Schedule`,
	...
	Object.assign(operationMetadata, {
		async action (req, resp, next) {
			...
			try {
				...
				const result = await api.schedules.deleteByEntityId(schedule_id);

				// DEBUG: delete-schedule result
				// console.debug(`🦠  delete-schedule result: ${JSON.stringify(result, null, 2)}`);
