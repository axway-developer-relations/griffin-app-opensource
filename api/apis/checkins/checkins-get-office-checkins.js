...
const operationMetadata = {
	group:       `checkins`,
	name:        `get-office-checkins`,
	path:        `/api/v1/offices/:office_id/checkins`,
	method:      `GET`,
	description: `Returns checkins associated with office identified by supplied office_id.`,
	parameters:  {
		office_id: { description: `ID of the office to find associated checkins`, type: `query`, optional: false  },
	...
	scopes:             [ `read:checkins`, `read:offices`  ],
	modelName:          `Checkin`,
	...
	Object.assign(operationMetadata, {
		async action (req, resp, next) {
			...
			try {
				...
				// DEBUG: get-office-checkins result
				// console.debug(`🦠  get-office-checkins result: ${JSON.stringify(result, null, 2)}`);
