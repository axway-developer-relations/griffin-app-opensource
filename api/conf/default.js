...
require(`@geek/dotenv`).config(`../.env`);
module.exports = {
	...
	// API key
	apikey: process.env.API_BUILDER_APIKEY,
	...
	/*
	  // In case you need to generate new keys...
	  const encryptionKey = crypto.randomBytes(32).toString('base64');
	  const signatureKey  crypto.randomBytes(64).toString('base64');
